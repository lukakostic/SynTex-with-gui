...
public static class SynTex
{
    ...
    static double Metric(int c1, int c2)
    {
...
static class Stuff
{
    ...
    public static int Random(this Dictionary<int, double> dic, double r)
    {
        return dic.Keys.ToArray()[dic.Values.ToArray().Random(r)];
    }
}